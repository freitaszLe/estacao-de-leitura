...
SECRET_KEY = 'django-insecure-g+&$3rh4rjz%4cuu$1!+cw#w052$721(l-7quz(0ml*x$3qb^6'
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # aqui é onde seus arquivos CSS, JS e imagens devem estar
]
...
EMAIL_FROM_DEFAULT = 'Estação Literária <nao-responda@estacaoliteraria.com>'
